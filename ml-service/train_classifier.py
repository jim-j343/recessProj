...
# Save the model next to this script (inside ml-service), no matter
# which directory the training command is run from
...
# - ngram_range=(1, 2) captures compound concepts as unified features
...
# 5-fold cross-validation gives a reliable accuracy estimate
...
joblib.dump(classifier, HERE / 'topic_classifier.pkl')
print(f"Model saved to {HERE / 'topic_classifier.pkl'}")