                    ...
                    <div class="mb-4">
                        ...
                        <select
                            ...
                            <option value="General"
                                ...
                                {{ old('category', $topic->category) == 'General' ? 'selected' : '' }}>
                            ...
                            <option value="Programming"
                                ...
                                {{ old('category', $topic->category) == 'Programming' ? 'selected' : '' }}>
                            ...
                            <option value="Mathematics"
                                ...
                                {{ old('category', $topic->category) == 'Mathematics' ? 'selected' : '' }}>
                            ...
                            <option value="Science"
                                ...
                                {{ old('category', $topic->category) == 'Science' ? 'selected' : '' }}>
                            ...
                            <option value="Announcements"
                                ...
                                {{ old('category', $topic->category) == 'Announcements' ? 'selected' : '' }}>
