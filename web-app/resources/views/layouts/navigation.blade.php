    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- DESKTOP NAV LINKS --}}
                <div class="hidden lg:flex lg:space-x-6 lg:-my-px lg:ms-10 lg:items-center">
                    ...
                    @if(auth()->user()->role === 'lecturer')
                        ...
                        <x-nav-link :href="route('participation.grade')" :active="request()->routeIs('participation.grade')">
                            Grading
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'lecturer')
                ...
                <x-responsive-nav-link :href="route('participation.grade')" :active="request()->routeIs('participation.grade')">
                    🧮 Grading
                </x-responsive-nav-link>
            @endif
